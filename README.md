**We are planning on second version of the grand-challenge and workshop. This time, we have multiple languages, new test set for CMU-MOSEI and MELD dataset (as well as original CMU-MOSI and POM). Please take your time to vote for Second Grand-challenge and Workshop on Multimodal Language  . This voting is very important even if you are tentatively planning on attending.**
...
Upcoming updates on CMU-MOSEI, please pull the dataset again on November 15th.
