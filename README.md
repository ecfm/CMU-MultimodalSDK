...
--> SDK is not trivial to use and the machine learning scientists are still involved in a lot of decision on how to handle cases where some csd has time gaps (like detector fails or nan values): a nice tutorial on how to use the SDK is prepared by Zhun Liu [here](https://github.com/Justin1904/CMU-MultimodalSDK-Tutorials)
